  ...
  if (index < UI::Dashboard::instance().totalWidgetCount() && index >= 0)
  {
    ...
    switch (widgetType())
    {
      ...
      case SerialStudio::DashboardGPS:
        ...
        m_qmlPath = "qrc:/Frequency-Calculator.com/gui/qml/Widgets/Dashboard/GPS.qml";
        break;
      case SerialStudio::DashboardLED:
        m_dbWidget = new Widgets::LEDPanel(relativeIndex(), this);
        m_qmlPath
            = "qrc:/Frequency-Calculator.com/gui/qml/Widgets/Dashboard/LEDPanel.qml";
        break;
      default:
        break;
    }
